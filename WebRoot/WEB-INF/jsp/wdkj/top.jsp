	...
	<table width="1222" border="0" align="center" cellpadding="0" cellspacing="0" background="${basePath}images/nsfw/xingzheng.png" class="top">
		<tr>
			...
			<td width="416" height="110" align="left" valign="middle">
				 <div style="width: 470;height: 90"><font size="15px" color="white">信息管理平台</font></div>
			</td>
			<td width="135">&nbsp;</td>
			<td width="418">
	...
	<div class="banner">
		<div class="menu">
			<ul class="clearfix">
                ...
                <li><a href="${basePath}nsfw/home_frame.action">信息管理</a></li>
                <li><a href="${basePath}wdkj/wdkj_frame.action">我的空间</a></li>
			</ul>
		</div>
	</div>
	<!-- }导航 -->
