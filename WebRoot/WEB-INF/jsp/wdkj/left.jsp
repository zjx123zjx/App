    ...
    <div class="xzfw_nav" style="width:214px;min-height:500px;">
        <div class="nBox" style="width:214px;">
            ...
            <div class="sm">
                ...
                <dl class="">
                    <dt><a class="yh" href="${ctx }wdkj/wdkj_MyCourse.action" target="mainFrame"><b></b>我的课程<s class="down"></s>
                    </a></dt>
                </dl>

                <dl>
                    <dt><a class="xxfb" href="${ctx}wdkj/wdkj_Myself.action" target="mainFrame"><b></b>基本信息<s
                            class="down"></s> </a></dt>
                </dl>
            </div>
        </div>
